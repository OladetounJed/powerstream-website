<template>
  <div class="container">
    ...
    <section
      ...
      data-image-src="~/assets/images/hero-bg-3000.jpg"
    ...
    <section id="about" class="s-about">
      <div class="row row-y-center about-content">
        <div class="column large-half medium-full">
          <h3 class="subhead">Welcome to The Powerstream Church</h3>
          <p class="lead">
            We are committed to raising men that will light their world 
            through various arms of our Ministry in Powerstream. At the 
            Powerstream Church, we believe in prayer that changes situation through the power of the Holy Ghost.
Engaging all kinds of prayer, we enforce the rule of heaven on Earth which bears its impact in our community and Nation.
          </p>
          <nuxt-link to="/about" class="btn btn--primary btn--about"
            >More About The Church</nuxt-link
          >
        </div>
        ...
        <div class="column large-half medium-full">
          <ul class="about-sched">
            <li>
              ...
              <p>
                Sunday: 8:00 AM - 10:00 AM (First Service)  <br />
                Sunday: 10:00 AM - 12:00 PM (Second Service)  <br />
               Opp. Sahwaad Filling Station Elite Rd, Oke-Lantoro, Abeokuta, Ogun State, Nigeria.
              </p>
            </li>
    ...
    <section class="s-series">
      <div
        class="series-img"
        style="background-image: url('../assets/images/series-2000.jpg');"
      ></div>
